...
shuf -n 40000 ${origin_dir}/strict_examples_cp.csv > ${origin_dir}/tmp.csv
split -l 20000 -d ${origin_dir}/tmp.csv ${origin_dir}/tmp
split -l 1000 -d ${origin_dir}/tmp00 ${train_dir}/train
split -l 1000 -d ${origin_dir}/tmp01 ${test_dir}/test
rm ${origin_dir}/tmp*
