...
## MaxLearn, UIUP PLP-trees, NurseryDownsampledFurther Dataset, 1 user, with 548064 examples over 1266 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/NurseryDownsampledFurther
