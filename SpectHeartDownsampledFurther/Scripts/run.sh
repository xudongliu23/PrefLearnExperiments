...
## MaxLearn, UIUP PLP-trees, SpectHeartDownsampledFurther Dataset, 1 user, with 3196 examples over 115 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/SpectHeartDownsampledFurther
