...
## MaxLearn, UIUP PLP-trees, Wine, 1 user, each with x examples over 178 outcomes.

number_of_users=1
root_dir=/home/xudong/Codes/PrefLearnExperiments_Train_Test/Wine
