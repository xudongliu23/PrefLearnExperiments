...
## MaxLearn, UIUP PLP-trees, CreditApprovalDownsampled Dataset, 1 user, with 101850 examples over 641 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/CreditApprovalDownsampledFurther
