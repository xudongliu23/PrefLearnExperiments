...
## MaxLearn, UIUP PLP-trees, Nursery, 1 user, each with x examples over 12960 outcomes.

number_of_users=1
root_dir=/home/xudong/Codes/PrefLearnExperiments_Train_Test/Nursery
...
function preRun {
	${Scripts_dir}/create_datasets.sh $root_dir $origin_dir $training_sample_size $number_of_all_examples
