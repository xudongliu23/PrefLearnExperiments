...
## MaxLearn, UIUP PLP-trees, Car Evaluation, 1 user, each with 1000 examples over 1728 outcomes.

number_of_users=1
root_dir=/home/xudong/Codes/PrefLearnExperiments_Train_Test/CarEvaluation
