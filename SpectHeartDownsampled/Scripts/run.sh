...
## MaxLearn, UIUP PLP-trees, SpectHeartDownsampled Dataset, 1 user, with 8112 examples over 181 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/SpectHeartDownsampled
