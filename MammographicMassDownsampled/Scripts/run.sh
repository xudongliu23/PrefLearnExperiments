...
## MaxLearn, UIUP PLP-trees, MammographicMass Dataset, 1 user, with 792 examples over 62 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/MammographicMassDownsampled
