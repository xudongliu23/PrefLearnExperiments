...
## MaxLearn, UIUP PLP-trees, IonosphereDownsampled Dataset, 1 user, with 11797 examples over 218 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/IonosphereDownsampled
