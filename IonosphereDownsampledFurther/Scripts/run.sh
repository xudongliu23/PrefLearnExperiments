...
## MaxLearn, UIUP PLP-trees, IonosphereDownsampledFurther Dataset, 1 user, with 3472 examples over 118 outcomes.

usr_dir=$3
number_of_users=1
number_of_iterations=20
root_dir=${usr_dir}/Codes/PrefLearnExperiments/IonosphereDownsampledFurther
